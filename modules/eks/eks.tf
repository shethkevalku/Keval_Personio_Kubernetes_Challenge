...
resource "aws_eks_cluster" "personio-eks" {
...
resource "aws_iam_role" "workernodes" {
  name = "eks-personio-challenge-role"
 ...
 resource "aws_eks_node_group" "worker-node-group" {
  cluster_name  = aws_eks_cluster.personio-eks.name
  node_group_name = "personio-eks-workernodes"
